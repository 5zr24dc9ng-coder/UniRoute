...
export const AU_DOCUMENTS: DocumentMaster[] = [
  ...
  // ── 語学留学・ワーホリ等からの切り替え（Onshore）で要求されやすい追加書類（該当する場合のみ） ──
  {
    ...
    notes: "ワーキングホリデービザ（Subclass 417/462）や観光ビザ（Subclass 600）等の現在のビザステータス証明。現在のビザに「No Further Stay（条件8503）」が付されている場合、国内からの学生ビザ申請は法的に不可能であり、出国して申請する必要がある。",
  },
  {
  ...
  },
  {
    ...
    source: "申請者本人",
    notes: "なぜワーホリや観光で入国した後に「突然オーストラリアでの就学が必要になったのか」、その就学が帰国後のキャリアにどう明確な利益（ROI）をもたらすのかを論理的に説明する補足文書。これが曖昧な場合、「単なる滞在延長目的」と見なされ高確率で却下される。",
  },
  {
